...
$stmt = $dbh->query("SELECT tblplot.*, estate.*,tblplot.ID FROM tblplot JOIN estate ON tblplot.estate_id=estate.ID where tblplot.plot_no='".$_SESSION['refplotno']."' and tblplot.estate_id='".$_SESSION['refestate']."'");
$row_prop = $stmt->fetch();
$id=$row_prop['ID'];
...
if (($amount) > ($row_prop['total_payable']) ){

$amount_payable=number_format((float) $amount_payable ,2);

$error='Amount Paid can not be greater than'. ' NGN'.$row_prop['total_payable'];
...
$redirect_url = "http://localhost/flexi_Homes/Client/invoice.php?pd=$amount&pl=".$_SESSION['refplotno']."&ID=$id&inv=$invoice_no"; // Set your own redirect URL
          ...
          <div class="card m-b-3">
            <div class="card-body">
              <div class="box-body"> 
                ...
                <strong><i class="fa-solid fa-dollar-sign margin-r-5"></i> Payable</strong>
                <p class="text-muted style1">NGN<?php echo number_format((float) $row_prop['total_payable'] ,2); ?></p>
                <hr>
            ...
            <div class="card tab-style1"> 
             ...
             <form  action="" method="POST" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <input name="txtamt" class="form-control form-control-line" type="num" value="" onkeyup = "javascript:this.value=convert(this.value);">
                        </div>
                      </div>
